...
/**
 * This is the extension manager of the Oorextension extension.
 */
public class OorextensionManager extends GeneratedOorextensionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(OorextensionManager.class);
	 ...
	 */
	public static OorextensionManager getInstance()
	{
		return (OorextensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(OorextensionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OorextensionManager() // NOPMD 
	{
		LOG.debug("constructor of OorextensionManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of OorextensionManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of OorextensionManager called, current tenant: {}", getTenant().getTenantID());
	}
