...
public class DefaultOorextensionService implements OorextensionService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultOorextensionService.class);
	...
	{
		return DefaultOorextensionService.class.getResourceAsStream("/oorextension/sap-hybris-platform.png");
	}
